...
@Entity
@Table(name = "DestructorPredictions",
        indexes = {
                @Index(name = "IX_DestructorPredictions_GroupId_UserId", columnList = "GroupId, UserId", unique = true),
                @Index(name = "IX_DestructorPredictions_UserId", columnList = "UserId")
        })
@Data
