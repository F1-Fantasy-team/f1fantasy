...
@Entity
@Table(name = "DriverDraftPredictions",
        indexes = {
                @Index(name = "IX_DriverDraftPredictions_GroupId_UserId", columnList = "GroupId, UserId", unique = true),
                @Index(name = "IX_DriverDraftPredictions_UserId", columnList = "UserId")
        })
@Data
